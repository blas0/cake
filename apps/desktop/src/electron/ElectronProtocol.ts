...
import { desktopScheme } from "../app/DesktopForkIdentity.ts";

export const DESKTOP_HOST = "app";
export const DESKTOP_PRODUCTION_SCHEME = desktopScheme(false);
export const DESKTOP_DEVELOPMENT_SCHEME = desktopScheme(true);
